...
// irrevocable worldwide license in this data to reproduce, prepare derivative works, distribute copies to 
// the public, perform publicly and display publicly, and to permit others to do so.  The specific term of
// the license can be identified by inquiry made to Battelle or DOE.  NEITHER THE UNITED STATES NOR THE 
// UNITED STATES DEPARTMENT OF ENERGY, NOR ANY OF THEIR EMPLOYEES, MAKES ANY WARRANTY, EXPRESS OR IMPLIED, 
// OR ASSUMES ANY LEGAL LIABILITY OR FOR THE ACCURACY, COMPLETENESS OR USEFULNESS OF ANY DATA, APPARATUS, 
